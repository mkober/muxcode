#!/bin/bash
# muxcoder-preview-hook.sh — PreToolUse hook for Write/Edit/NotebookEdit
#
...
SKIP_PATTERNS="${MUXCODER_PREVIEW_SKIP:-/.claude/settings.json /.claude/CLAUDE.md /.muxcoder/}"
