#!/bin/bash
# muxcoder-git-status.sh - Poll git status every N seconds
# Used in the commit window's left pane during muxcoder sessions
#
# Usage: muxcoder-git-status.sh [interval_seconds]
