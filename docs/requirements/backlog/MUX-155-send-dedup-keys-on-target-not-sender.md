...
| [`MUX-154`](../completed/MUX-154-codex-status-line-closes-tracked-tasks.md) | Same family of "the bus says one thing and did another" — that one records a success that did not happen; this one reports tracking for a message that does not exist |
