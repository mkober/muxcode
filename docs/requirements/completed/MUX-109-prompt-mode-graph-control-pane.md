...
|-------|----------------|-----------------|
| Intent: **launch** — resolve across scopes and start via `graph run` (criteria + Phase 4 + Phase 7 steps) | A core intent of the feature. The pane can be told to launch a graph and will not | **Measured failing.** Timed out ×4 consecutive runs; turn budget exhausted before the command. Tracked as [MUX-115](../drafts/MUX-115-prompt-agent-turn-budget-exhaustion.md) |
| Intent: **named gate approval** releases the gate (criteria + Phase 7 step) | The gate path is the authority-sensitive one; a gate that cannot be approved by name is not usable | **Measured failing.** Same exhaustion signature, same 4 runs. [MUX-115](../drafts/MUX-115-prompt-agent-turn-budget-exhaustion.md) |
...
**If this spec is reopened, start with [MUX-115](../drafts/MUX-115-prompt-agent-turn-budget-exhaustion.md).**
...
| Carried to | Covers |
|-----------|--------|
| [MUX-115](../drafts/MUX-115-prompt-agent-turn-budget-exhaustion.md) | The two failing live intents (`launch`, named-`approve`) — instrument the turn budget before attempting a fifth fix |
