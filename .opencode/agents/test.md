...
**Send exactly ONE reply per request. Do NOT send additional messages to edit or review.**

- **After tests pass, send a review request manually** (no auto-chain):
`muxcode send review review "Tests passed — review the changes and report results to edit" --type request`
