...
var msgPatternRe = regexp.MustCompile(`(?i)(Message from|SendMessage|broadcast|→|muxcode-agent-bus send|muxcode-agent-bus inbox|agent-bus send|agent-bus inbox|Sent\s.*to )`)
