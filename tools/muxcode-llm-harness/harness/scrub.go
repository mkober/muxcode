...
// redactions occurred, so a PII-sensitive agent does not mistake redacted
// placeholders for real data or compute lengths/sizes/counts over masked text.
// NOTE: mirrored in tools/muxcode/bus/scrub.go.
